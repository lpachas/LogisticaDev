...
<div class="modal fade" id="edit_cliente_mod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <label for="nombre">Nombre:</label>
                                <input type="text" id="nombre_edit" name="nombre_edit" class="form-control" placeholder="Nombre">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="direccion">Dirección:</label>
                                <input type="text" name="direccion_edit" id="direccion_edit" class="form-control" placeholder="Dirección" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="ruc_dni">RUC o DNI:</label>
                                <input type="text" name="doc_edit" id="doc_edit" class="form-control" placeholder="RUC o DNI" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="apellido_paterno">Teléfono:</label>
                                <input type="text" name="telefono_edit" id="telefono_edit" class="form-control" placeholder="999999999">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="tipos">Zona</label>
                                <input type="text" name="zona_edit" id="zona_edit" class="form-control" placeholder="Zona" required>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <div class="box-footer text-center">
                        <button class="btn btn-primary" type="button" id="btnedit_cliente">Registrar</button>
                        <button class="btn" data-dismiss="modal" aria-hidden="true"> Cancelar</button>
                    </div>
                </div>
                <div id="mensaje_cliente_edit"></div>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
